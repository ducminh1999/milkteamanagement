			...
			<div class="p-4">
				<div class="card card-primary">
					...
					<div class="p-4">
						...
						%>
						<div class="p-2">
							<form method="post" action="<%=contextPath%>/admin/addUser" id="addUser">
									...
									<div class="col-10">
										<div class="custom-control custom-radio custom-control-inline">
											<input name="roleId" id="role_0" type="radio" class="custom-control-input" value="1"
												<%if (user.getRoleId() == 1) {%> checked="checked" <%}%> /> <label for="role_0"
												class="custom-control-label">Manager</label>
										</div>
										<div class="custom-control custom-radio custom-control-inline">
											<input name="roleId" id="role_1" type="radio" class="custom-control-input" value="2"
												<%if (user.getRoleId() == 0 || user.getRoleId() == 2) {%> checked="checked" <%}%> /> <label for="role_1"
