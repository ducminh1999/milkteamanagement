			...
			<div class="p-4">
				<div class="card card-primary">
					...
					<div class="p-4">
						...
						%>
						<div class="p-2">
							<form method="post" action="<%=contextPath%>/admin/product/add" id="addProduct">
								...
								<div class="form-group row">
									...
									<div class="col-10 input-group mb-3">
										<div class="custom-file">
											<input class="form-control" id="imageFile" name="imageFile" type="text"
												value="<%=product.getImageFile() == null ? "" : product.getImageFile()%>">
										</div>
									</div>
								</div>
								<div class="form-group row">
