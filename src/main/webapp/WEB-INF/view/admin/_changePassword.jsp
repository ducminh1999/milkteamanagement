							...
							<div class="widget wid-categories">
								...
								<div class="content">
									<ul class="nav flex-column">
										<li class="nav-item"><a class="nav-link" href="<%=contextPath%>/myAccount">Edit Account</a></li>
										<li class="nav-item"><a class="nav-link" href="<%=contextPath%>/paymentHistory">Payment History</a></li>
										<li class="nav-item"><a class="nav-link" href="<%=contextPath%>/changePassword" style="color: red;">Change
												Password</a></li>
							...
							<div class="widget wid-categories">
								...
								<div class="content">
									...
									<form method="post" action="<%=contextPath%>/changePassword">
										...
										<button type="submit" class="btn btn-primary" onclick="validate();">Change Password</button>
									</form>
									<script>
										function checkPass() {
											var passNew = document
													.getElementById("passNew").value
											var rePassNew = document
													.getElementById("rePassNew").value
											if (passNew !== rePassNew) {
												document
														.getElementById("message").innerHTML = "Not Matching Password";
											} else {
												document
