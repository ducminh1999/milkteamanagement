...
<body>
	...
	<div class="body_wrap">
		...
		List<ProductDto> listProduct = (List<ProductDto>) request.getAttribute("listProductRelated");
				...
				<div class="container">
					<div class="row justify-content-lg-between justify-content-md-center justify-content-sm-center">
						<div class="col-lg-6 col-md-7">
							<img style="max-width: 580px; max-height: 400px" src="<%=product.getImageFile()%>" alt="image_not_found">
						</div>
						<div class="col-lg-6 col-md-7">
							<div class="details_content wow fadeInUp" data-wow-delay=".2s">
								<div class="details_flex_title">
									<h2 class="details_title text-uppercase"><%=product.getName()%></h2>
								</div>
									...
									<ul class="btns_group ul_li">
										<li>
											<div class="quantity_input quantity_boxed">
												...
												<input class="input_number" name="quantity" type="text" value="1" min="0">
												<button type="button" class="input_number_increment">+</button>
											</div> <input type="hidden" name="id" value="<%=product.getId()%>">
										</li>
										<li><button class="btn btn_secondary text-uppercase">Add To Cart</button></li>
									</ul>
								</form>
					...
					<div class="product_description_wrap wow fadeInUp" data-wow-delay=".3s">
						<ul class="tabs_nav ul_li nav" role="tablist">
							<li>
								<button class="active" data-bs-toggle="tab" data-bs-target="#product_description" type="button" role="tab"
									aria-selected="true">Product Details</button>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane fade show active" id="product_description" role="tabpanel">
								<p class="mb-0"><%=(product.getDescription() == null || "".equals(product.getDescription())) ? "Không có thông tin nào cho sản phẩm" : product.getDescription()%></p>
							</div>
						</div>
					</div>
					<div class="related_products">
						<h4 class="area_title text-uppercase mb-0 wow fadeInUp mb-4" data-wow-delay=".1s">Related Product</h4>
					...
					<div class="shop_filter_grid grid wow fadeInUp" data-wow-delay=".3s">
							...
							<div class="element-item chocolate greantea " data-category="chocolate">
								<div class="shop_card">
									...
									<a class="item_image" href="<%=contextPath%>/product?id=<%=listProduct.get(i).getId()%>"> <img
										style="max-width: auto; max-height: 200px;" src="<%=listProduct.get(i).getImageFile()%>" alt="image_not_found">
									</a>
									<div class="item_content">
										<h3 class="item_title text-uppercase">
											<a href="shop_details.html"><%=listProduct.get(i).getName()%></a>
										</h3>
										<div class="btns_group">
											<span class="item_price bg_default_brown"><%=listProduct.get(i).getPrice()%> VND</span> <a
												class="btn btn_border border_black text-uppercase"
												href="<%=contextPath%>/cart/add?id=<%=listProduct.get(i).getId()%>">Add To Cart</a>
										</div>
									</div>
								</div>
							</div>
