							...
							<nav class="main_menu navbar navbar-expand-lg">
								...
								<div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
									<ul class="main_menu_list ul_li">
										<li class="active dropdown"><a class="nav-link" href="<%=contextPath%>/home"> Home </a>
			...
			<section class="shop_section sec_ptb_120 bg_default_gray">
				<div class="container">
					<ul class="filters-button-group ul_li_center wow fadeInUp" data-wow-delay=".1s">
						<li><a href="<%=contextPath%>/home"><button <%if (categoryId.equals("all")) {%>
									class="button text-uppercase active" <%} else {%> class="button text-uppercase" <%}%> data-filter="*">all</button></a></li>
						<%
							for (int i = 0; i < listCategory.size(); i++) {
						%>
						<li><a href="<%=contextPath%>/category?id=<%=listCategory.get(i).getId()%>"><button
									<%if (categoryId.equals(String.valueOf(listCategory.get(i).getId()))) {%> class="button text-uppercase active"
									<%} else {%> class="button text-uppercase" <%}%> data-filter="*"><%=listCategory.get(i).getName()%></button></a></li>
						<%
							}
						%>
					</ul>
