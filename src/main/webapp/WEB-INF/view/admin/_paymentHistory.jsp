...
<body>
								...
								<section class="content">
									<table class="table table-striped">
										...
										<tbody>
											...
											%>
											<tr>
												<td scope="row"><%=listBill.get(i).getId()%></td>
												<td><%=listBill.get(i).getCreateAt()%></td>
												<td><%=listBill.get(i).getTotal()%> VND</td>
												<td>
													<%
														if (listBill.get(i).getStatus() == 0) {
													%><p style="color: red;">Pending</p> <%
 	} else if (listBill.get(i).getStatus() == 1) {
 %><p
														style="color: #9c27b0">Delivering</p> <%
 	} else if (listBill.get(i).getStatus() == 2) {
 %><p
														style="color: #32c67b;">Completed</p> <%
 	} else {
 %><p style="color: #847713;">Cancelled</p>
												...
												<td><a href="<%=contextPath%>/paymentDetail?id=<%=listBill.get(i).getId()%>"><button name="Detail">Detail</button></a></td>
											</tr>
											<%
												}
											%>
